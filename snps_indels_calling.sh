...
# normalization
bcftools norm -f /mnt/ssd/data/GRCh38/Homo_sapiens.GRCh38.dna.chromosome.giaborder.fa.gz ./tmp/rnmd-chr.snps.vcf.gz -Oz -o ./tmp/norm_snps.vcf.gz -c s
bcftools norm -f /mnt/ssd/data/GRCh38/Homo_sapiens.GRCh38.dna.chromosome.giaborder.fa.gz ./tmp/rnmd-chr.indels.vcf.gz -Oz -o ./tmp/norm_indels.vcf.gz -c s
